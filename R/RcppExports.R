...
parse_vcf <- function(filename, samples, bad_positions, variants, DP, GQ, gmatrix, predictMissing, regions, binary_prefix, missingRateThreshold, seed, window_size, rf_ntrees, checkpoint_dir, checkpoint_interval, resume_checkpoint) {
    .Call('_SVDFunctions_parse_vcf', PACKAGE = 'SVDFunctions', filename, samples, bad_positions, variants, DP, GQ, gmatrix, predictMissing, regions, binary_prefix, missingRateThreshold, seed, window_size, rf_ntrees, checkpoint_dir, checkpoint_interval, resume_checkpoint)
}
