...
parse_vcf <- function(filename, samples, bad_positions, variants, DP, GQ, gmatrix, predictMissing, excludedPredictors, regions, binary_prefix, missingRateThreshold) {
    .Call('_SVDFunctions_parse_vcf', PACKAGE = 'SVDFunctions', filename, samples, bad_positions, variants, DP, GQ, gmatrix, predictMissing, excludedPredictors, regions, binary_prefix, missingRateThreshold)
}
