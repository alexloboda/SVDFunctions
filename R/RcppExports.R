...
parse_vcf <- function(filename, samples, bad_positions, available_positions, DP, GQ, ret_gmatrix, binary_prefix) {
    .Call('_SVDFunctions_parse_vcf', PACKAGE = 'SVDFunctions', filename, samples, bad_positions, available_positions, DP, GQ, ret_gmatrix, binary_prefix)
}
