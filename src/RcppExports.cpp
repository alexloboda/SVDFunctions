...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(parse_binary_file(variants, samples, binary_file, metafile, r_min_maf, r_max_maf, r_min_cr, r_min_mac, r_max_mac, report_singletons, requiredDP, requiredGQ));
    return rcpp_result_gen;
END_RCPP
}
